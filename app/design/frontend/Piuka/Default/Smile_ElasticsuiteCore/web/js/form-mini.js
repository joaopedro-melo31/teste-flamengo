...
define([
    ...
    $.widget('smileEs.quickSearch', $.mage.quickSearch, {
        ...
        _getResultWrapper: function () {
            let noResult = $t("No results Found");

            return $('<div class="smile-elasticsuite-autocomplete-result">' +
                '<div class="mini-search-no-result">' +
                '<span>'+ noResult + '</span></div></div>');
        },
            ...
            if (value.trim().length >= parseInt(this.options.minSearchLength, 10)) {
                ...
                this.currentRequest = $.ajax({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        if (data.length === 0) {
                            let noSearchElement = content.find(".mini-search-no-result");
                            console.log("eh do tema sem resultado");
                            noSearchElement.show();
                        } else {
                            let noSearchElement = content.find(".mini-search-no-result");
                            console.log("eh do tema com resultado");
                            noSearchElement.hide();
                        }
